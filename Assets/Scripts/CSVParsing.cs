...
public class CSVParsing : MonoBehaviour
{
    ...
    public void addData()
    {
        ...
        File.AppendAllText(filePath, lineSeperater + nameInputField.text + fieldSeperator + menuTechnique + fieldSeperator + selectionTechnique + fieldSeperator + testText);
